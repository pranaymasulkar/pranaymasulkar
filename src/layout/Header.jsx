    ...
    return (
        <>
            <header className="relative w-full h-10 flex justify-between items-center text bg-[#161616] text-white z-50 py-13 px-5 sm:px-6 md:px-10 lg:px-12 xl:px-12 2xl:px-13">
                {/* Logo */}
                <div className="text-3xl md:text-4xl font-black tracking-widest text-white capitalize underline">
                    <a href="/">pranay masulkar</a>
                </div>
                ...
                <AnimatePresence>
                    {isOpen && (
                        <motion.div
                            className="fixed overflow-y-scroll inset-0 bg-white flex flex-col gap-10 py-12 px-8 md:px-12 items-center justify-center z-50 my-5 mx-5 sm:mx-6 :mmd:mx-10 rounded-4xl"
                        ...
                        >
                            <button
                                ...
                                className="absolute cursor-pointer right-3 top-3 text-white hover:bg-[#04AA6D] bg-[#161616] font-black rounded-full p-4"
                            >
                                <IoClose size={30} />
                            </button>
                            {/* Close Button */}
