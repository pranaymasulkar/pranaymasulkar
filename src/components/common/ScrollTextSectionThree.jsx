...
const ScrollTextSection = ({ data, className, imageSize }) => {
    ...
    return (
        <div className="relative h-[30vh] bg-[#161616] flex items-center justify-center overflow-hidden">
            <div
            ...
            >
                {data.map((item, index) => (
                    <React.Fragment key={index}>
                        <svg version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width={imageSize} height={imageSize} viewBox="0 0 20 20" fill="currentColor">
