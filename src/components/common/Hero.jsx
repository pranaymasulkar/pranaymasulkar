                ...
                <div className="mx-auto w-full block md:flex justify-around items-center pt-0 pb-0 md:pb-10">
                    ...
                    <div className="h-full w-full sm:w-full md:w-[50%] lg:w-[50%] xl:w-[50%] 2xl:w-[50%] relative">
                        <motion.div
                            ...
                            className="backdrop-blur-[10px] md:backdrop-blur-[5px] w-[45%] md:w-[160px] absolute bottom-0 left-3 md:bottom-auto md:top-60 md:-left-20 border border-[#c2adbb] rounded-xl md:rounded-2xl bg-[#d3bccd3b] md:bg-[#00000069] inline-block p-3 md:p-5 shadow-lg md:shadow-[#d7bdd1aa]">
