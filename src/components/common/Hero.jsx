                ...
                <div className="mx-auto w-full block md:flex justify-around items-center pt-0 pb-0 md:pb-10">
                    ...
                    <div className="h-full w-full sm:w-full md:w-[50%] lg:w-[50%] xl:w-[50%] 2xl:w-[50%] relative">
                        <motion.div
                            ...
                            className="backdrop-blur-[10px] md:backdrop-blur-[5px] w-[45%] md:w-[160px] absolute bottom-5 left-3 md:bottom-auto md:top-60 md:-left-20 border border-[#c2adbb] rounded-xl md:rounded-2xl bg-[#d3bccd3b] md:bg-[#00000069] inline-block p-3 md:p-5 shadow-lg md:shadow-[#d7bdd1aa]">
                        ...
                        <motion.div
                            ...
                            className="backdrop-blur-[10px] md:backdrop-blur-[5px] w-[45%] md:w-[160px] absolute bottom-5 md:bottom-auto right-3 md:top-70 md:-right-20 border border-[#c2adbb] rounded-xl md:rounded-2xl bg-[#d3bccd3b] md:bg-[#00000069] inline-block p-3 md:p-5 shadow-lg md:shadow-[#d7bdd1aa]">
                            <h3 className="text-3xl md:text-5xl leading-[1.7] font-semibold text-balance text-white">
                                6+
                                <p className="text-sm md:text-lg mt-0 font-light">
                                    Years of <br />
