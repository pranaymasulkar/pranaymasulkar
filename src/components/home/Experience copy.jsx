...
const Experience = () => {
    return (
        <div className="bg-[#161616] py-24 sm:py-32">
            <div className="mx-auto max-w-2xl px-6 lg:max-w-7xl lg:px-8">
                <div className="flex w-full justify-between items-center mb-30">
                    <h2 className="text-7xl w-50 font-bold lh-1 tracking-tight text-pretty text-white">Experience</h2>
                    <p className="mt-5 w-50 text-lg/8 text-gray-300">Learn how to grow your business with our expert advice.</p>
                    <div className="relative ">

                        <a href="#" className="rounded-full px-7 py-2 text-xl/6 text-gray-400 hover:text-white ring-1 ring-white/10 hover:ring-white">
                            All Works <span aria-hidden="true">&rarr;</span>
                        </a>
                    </div>
                </div>
