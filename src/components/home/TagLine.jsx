...
const TagLine = () => {
    return (
        <section className='w-full h-auto bg-[#161616] py-12 md:py-24 px-5 sm:px-6 md:px-10 lg:px-12 xl:px-12 2xl:px-13'>
            <div className='w-full md:w-[80%] text-center mx-auto'>
                ...
                <div className='flex gap-3 justify-center'>
                    <Link to="/works" className="rounded-full tracking-widest capitalize font-bold px-6 py-3 text-xl/6 text-[#161616] hover:bg-white ring-1 ring-gray-300 bg-gray-300 hover:ring-white me-3">
                        My Works
                    </Link>
