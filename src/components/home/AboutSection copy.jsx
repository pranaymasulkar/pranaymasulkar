    ...
    return (
        <div className="bg-[#161616] py-24 sm:py-32">
            <div className="mx-auto max-w-2xl px-6 lg:max-w-7xl lg:px-8">
                <h2 className="text-center text-base/7 font-semibold text-indigo-400"></h2>
                <p className="mx-start mt-2 max-w-xl text-center text-4xl font-semibold tracking-tight text-balance text-white sm:text-5xl">
                    About Me
                </p>
