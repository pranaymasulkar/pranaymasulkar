...
import ScrollTextSectionOne from "../common/ScrollTextSectionOne";
...
const Hero = () => {
    ...
    return (
        <div className="relative overflow-hidden bg-[#161616]">
            <ScrollTextSectionOne data={data} />
                ...
                <div className="mx-auto w-full block md:flex justify-around items-center pt-0 pb-0 md:pb-10">
                    ...
                    <div className="relative w-full sm:w-full md:w-[50%] lg:w-[50%] xl:w-[50%]">
                        ...
                        <div className="mb-30 md:mb-0">
                            <Image src={PranayMasulkar} alt="Pranay Masulkar" priority className="rounded-2xl md:rounded-full" />
                        </div>
                        <motion.div
                            ...
                            className="flex justify-center md:justify-start items-center backdrop-blur-[10px] md:backdrop-blur-[5px] absolute -top-5 transform translate-[-50%] left-[50%] md:left-auto right-auto md:top-20 md:-right-10 border border-[#c2adbb] rounded-xl md:rounded-2xl bg-[#d3bccd3b] md:bg-[#00000069] px-6 md:px-5 py-2 md:py-3 shadow-lg shadow-[#d7bdd1aa]">
                            <motion.div className="text-[#04AA6D] me-3"
                                animate={{ rotate: 360, }}
                                transition={{ duration: 1, repeat: Infinity, }}> <StarImage /></motion.div>
                            <p className="text-white text-nowrap leading-[1.7] text-sm md:text-lg font-bold uppercase">
                                Open to Work
                            </p>
                        </motion.div>
                        <motion.div
